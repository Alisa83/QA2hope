...
public class FirstTvNetTest {
    ...
    private final By NAME = By.name("elementName");
    private final By LOCATOR_BY_TAGNAME =By. tagName ("name OfTag");
    ...
    public void firstTest() {
        ...
        System.setProperty("webdriver.chrome.driver", "C://Users/Zara/Downloads/chromedriver.exe");
